...
class MainWindow(QTabWidget):
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        # 温度检测界面
        font_title1 = QFont('楷体', 16)
        font_main1 = QFont('楷体', 14)
        # 温度检测界面, 两个按钮，开始检测和停止检测
        img_detection_widget1 = QWidget()
        # img_detection_layout1 = QVBoxLayout()
        # img_detection_title1 = QLabel("温度功能")
        # img_detection_title1.setFont(font_title1)
        # mid_img_widget1 = QWidget()
        # mid_img_layout1 = QHBoxLayout()
        # self.left_img1 = QLabel()
        # self.right_img1 = QLabel()
        # self.left_img1.setPixmap(QPixmap("images/UI/up.jpeg"))
        # self.right_img1.setPixmap(QPixmap("images/UI/right.jpeg"))
        ...
        # up_img_button1.clicked.connect(self.upload_img)
        # det_img_button1.clicked.connect(self.detect_img)
        # up_img_button1.setFont(font_main1)
        # det_img_button1.setFont(font_main1)
        ...
        self.addTab(img_detection_widget1, '温度检测')
